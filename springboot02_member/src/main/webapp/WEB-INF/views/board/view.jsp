...
<script type="text/javascript">
	$(document).ready(function() {
       $("#list").click(function(){
    	   $('#frm').attr("action","/board/list.do").submit();
       });
       
       $("#reply").click(function(){
    	   $('#frm').attr("action","/board/write.do").submit();
       });
       
       $('#update').click(function(){
    	   $('#frm').attr("action","/board/update.do").submit();
       });
	...
	<table>
		...
		<tr>
			...
			<td colspan="3"><c:if test="${!empty dto.upload}">
					<a href="/board/contentdownload.do?num=${dto.num}">
